...
public class TestBase {
    ...
    public static IConfig MAIN_CONFIG = ConfigFactory.create(IConfig.class, System.getProperties());

    @BeforeAll
    public static void beforeAll() {
        addListener("AllureSelenide", new AllureSelenide());
        Configuration.browser = BrowserstackMobileDriver.class.getName();
        Configuration.startMaximized = MAIN_CONFIG.startMaximized();
        Configuration.browserSize = null;
        Configuration.timeout = MAIN_CONFIG.timeout();
    }
